...
/**
 *	\file       htdocs/facturacion/liste.php
 *	\ingroup    commande
...
require_once 'commanda.class.php';
require_once 'societearg.class.php';
...
$companystatic = new Societearg($db);


$help_url="EN:Module_Customers_Orders|FR:Module_Commandes_Clients|ES:Módulo_Pedidos_de_clientes";
llxHeader('',$langs->trans("Orders"),$help_url);
//exit; genera pantalla std
...
if ($resql)
{
	if ($socid)
	{
		...
		$title="Listado de Pedidos para Facturar";
	}
	else
	{
	...
	$generic_commande = new comanda($db);
	while ($i < min($num,$limit))
	{
		...
		print $generic_commande->getFactureUrl(1,($viewstatut != 2?0:$objp->fk_statut));
		...
		*/
		...
		//print $companystatic->getCompanyUrl(1,'customer');
		print $companystatic->getFullName($langs);
