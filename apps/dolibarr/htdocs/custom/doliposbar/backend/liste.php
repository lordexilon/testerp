...
/**
 *	\file       htdocs/doliposbar/backend/liste.php
 *	\ingroup    ticket
...
{
	print '<a href="'.dol_buildpath('/doliposbar/frontend/index.php',1).'"><img src='.dol_buildpath('/doliposbar/frontend/img/bgback.png',1).' WIDTH="50%" HEIGHT="50%" ></a>';
}	
else {
	if ($page == -1) $page = 0 ;
	...
	if ($resql)
	{
		...
		if ($closeid)
		{
			...
			print '<a class="butAction" href="'.dol_buildpath('/doliposbar/backend/liste.php',1).'?closeid='.$closeid.'&terminalid='.$terminalid.'&viewstatut=2&action=mail">'.$langs->trans('MailCopy').'</a>';
