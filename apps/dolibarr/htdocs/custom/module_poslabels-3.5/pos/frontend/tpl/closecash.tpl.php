...
<div class="entete">
	...
	<div class="infos">
		...
		<?php
			...
			print '<p class="date_heure">'.dol_print_date($db->jdate($date),'dayhour').'</p>';
		?>
	</div>
</div>
...
<table class="totaux">
	...
	if($subtotalcashlt1)
		echo '<tr><th nowrap="nowrap">'.$langs->transcountrynoentities("TotalLT1",$mysoc->country_code).'</th><td nowrap="nowrap">'.price($subtotalcashlt1)." ".$langs->trans(currency_name($conf->currency))."</td></tr>\n";
	if($subtotalcashlt2)
		echo '<tr><th nowrap="nowrap">'.$langs->transcountrynoentities("TotalLT2",$mysoc->country_code).'</th><td nowrap="nowrap">'.price($subtotalcashlt2)." ".$langs->trans(currency_name($conf->currency))."</td></tr>\n";
