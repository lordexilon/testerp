...
/**
 *       \file        htdocs/doliposbar/backend/resultat/casoc.php
...
if (sizeof($amount))
{
	...
	foreach($arrayforsort as $key=>$value)
	{
		...
		$url = dol_buildpath('/doliposbar/backend/listefac.php?placeid='.$key,1);
        ...
        print '&nbsp;<a href="'.dol_buildpath('/doliposbar/backend/place/annuel.php?id='.$key,1).'">'.img_picto($langs->trans("MonthlyReporting"),"stats").'</a>&nbsp;';
        print '&nbsp;<a href="'.dol_buildpath('/doliposbar/backend/place/graph.php?id='.$key,1).'">'.img_picto($langs->trans("Graph"),"stats").'</a>&nbsp;';
        print '</td>';
