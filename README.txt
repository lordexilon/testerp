                    Bitnami Dolibarr Stack 3.9.1-1
                  ==============================
...
bitnami-dolibarr-3.9.1-1-linux-installer.run on Linux or
bitnami-dolibarr-3.9.1-1-linux-x64-installer.run on Linux 64 bit or
bitnami-dolibarr-3.9.1-1-windows-installer.exe on Windows or
bitnami-dolibarr-3.9.1-1-osx-x86_64-installer.dmg on OS X x64 or
bitnami-dolibarr-3.9.1-1-osx-x86-installer.dmg on OS X x86.

On Linux, you will need to give it executable permissions:

chmod 755 bitnami-dolibarr-3.9.1-1-linux.run
...
Stack in /home/user/dolibarr-3.9.1-1 on Linux or C:\Program Files\Bitnami Dolibarr Stack
on Windows or /Applications/dolibarr-3.9.1-1 and that you use port 
...
"Cannot open bitnami-dolibarr-3.9.1-1-linux.run: No application suitable for
...
/home/user/dolibarr-3.9.1-1/apache2/logs/error.log on Linux or
C:\Program Files\Bitnami Dolibarr Stack\apache2\logs\error.log on Windows or
/Applications/dolibarr-3.9.1-1/apache2/logs/error.log on OS X.
