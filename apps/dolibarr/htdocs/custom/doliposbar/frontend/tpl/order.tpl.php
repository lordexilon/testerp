...
<div class="entete">
	...
	<div class="infos">
		...
		<?php
			...
			// Variables
			$sql="SELECT rowid FROM ".MAIN_DB_PREFIX."commande where ref='Place-$id'";
			$resql = $db->query($sql);
			...
			$place = str_replace("Place-", "", $object->ref);
			print '<p class="date_heure" align="right">'.$langs->trans("CheckBar")." ".$langs->trans("Table")." ".$place."</p><br>";
		?>
	</div>
</div>
