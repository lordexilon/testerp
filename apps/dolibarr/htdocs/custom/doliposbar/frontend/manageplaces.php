...
<head>
	...
	<center>
	<div style="float:left; width=40px;"><img src="./img/arrow-prev.png" width="40px" onclick="location.href='manageplaces.php?zone=<?php if ($zone>1) { $zone--; echo $zone; $zone++;} else echo "1"; ?>';"></div><div id="zonename" onblur='updatezonename();' style="float:left" contenteditable><h1>
	<?php
	...
	?>
	</h1></div><div style="float:left; width=40px;"><img src="./img/arrow-next.png" width="40px" onclick="location.href='manageplaces.php?zone=<?php $zone++; echo $zone; ?>';"></div>
	</center>
	</div>
	</body>
</html>