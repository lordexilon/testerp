 ...
 */
abstract class ModelePDFFactArg extends CommonDocGenerator
 ...
 */
abstract class ModeleNumRefFactArg{
	var $error='';

	/**
	 * Return if a module can be used or not
	 *
	 * @return	boolean     true ifmodele module can be used
	 */
	function isEnabled()
	{
		return true;
 ...
 */
function facture_pdf_create_arg($db, $object, $modele, $outputlangs, $hidedetails=0, $hidedesc=0, $hideref=0, $hookmanager=false)
{
