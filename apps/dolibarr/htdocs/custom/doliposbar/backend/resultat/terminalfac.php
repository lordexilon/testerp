...
if (sizeof($amount))
{
	...
	foreach($arrayforsort as $key=>$value)
	{
		...
		$url = dol_buildpath('/doliposbar/backend/listefac.php?cashid='.$key,1);
        ...
        print '&nbsp;<a href="'.dol_buildpath('/doliposbar/backend/terminal/annuel.php?id='.$key,1).'">'.img_picto($langs->trans("MonthlyReporting"),"stats").'</a>&nbsp;';
        print '&nbsp;<a href="'.dol_buildpath('/doliposbar/backend/terminal/graph.php?id='.$key,1).'">'.img_picto($langs->trans("Graph"),"stats").'</a>&nbsp;';
        print '</td>';
