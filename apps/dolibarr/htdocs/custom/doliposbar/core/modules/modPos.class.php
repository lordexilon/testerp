...
class modPos extends DolibarrModules
{
	...
	function modPos($DB)
	{
		...
		$this->description = $langs->trans("DoliposBAR");
		...
		$this->dirs = array("/doliposbar/temp");
		$r=0;
		...
		$this->config_page_url = array("pos.php@doliposbar");

		// Dependencies
		$this->depends = array("modBanque","modFacture","modProduct","modCommande","modCategorie");		// List of modules id that must be enabled if this module is enabled
		$this->requiredby = array();	// List of modules id to disable if this one is disabled
		$this->phpmin = array(5,0);					// Minimum version of PHP required by module
		$this->need_dolibarr_version = array(3,5);	// Minimum version of Dolibarr required by module
		$this->langfiles = array("pos@doliposbar");
...
if ($DOLIPOSBARPRO!=1) {
		 $this->menu[$r]=array(	'fk_menu'=>0,			// Put 0 if this is a top menu
									...
									'url'=> '/doliposbar/frontend/index.php',
									'langs'=>'pos@doliposbar',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
		...
		if($conf->global->POS_FACTURE){$url='/doliposbar/backend/listefac.php';}
		else {$url='/doliposbar/backend/liste.php';}
		...
		// Example to declare a Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=0',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'titre'=>'Tickets',
									'mainmenu'=>'pos',
									'url'=>'/doliposbar/backend/liste.php',
									'langs'=>'pos@doliposbar',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
		...
		// Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=2',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'mainmenu'=>'pos',
									'url'=>'/doliposbar/backend/liste.php?viewstatut=0',
									'langs'=>'pos@doliposbar',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
									'enabled'=>'$conf->global->POS_USE_TICKETS',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		// Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=2',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'mainmenu'=>'@pos',
									'url'=>'/doliposbar/backend/liste.php?viewstatut=1',
									'langs'=>'main',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
									'enabled'=>'$conf->global->POS_USE_TICKETS',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		// Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=2',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'mainmenu'=>'@pos',
									'url'=>'/doliposbar/backend/liste.php?viewstatut=2',
									'langs'=>'main',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
									'enabled'=>'$conf->global->POS_USE_TICKETS',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r]=array(	'fk_menu'=>'r=2',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'mainmenu'=>'@pos',
									'url'=>'/doliposbar/backend/liste.php?viewstatut=3',
									'langs'=>'main',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
									'enabled'=>'$conf->global->POS_USE_TICKETS',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		// Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=2',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'mainmenu'=>'@pos',
									'url'=>'/doliposbar/backend/liste.php?viewtype=1',
									'langs'=>'main',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
									'enabled'=>'$conf->global->POS_USE_TICKETS',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r]=array(	'fk_menu'=>'r=0',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'titre'=>'Factures',
									'mainmenu'=>'pos',
									'url'=>'/doliposbar/backend/listefac.php',
									'langs'=>'pos@doliposbar',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
		...
		$this->menu[$r]=array(	'fk_menu'=>'r=9',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'mainmenu'=>'@pos',
									'url'=>'/doliposbar/backend/listefac.php?viewstatut=1',
									'langs'=>'bills',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
									'enabled'=>'$conf->global->POS_FACTURE',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		// Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=9',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									 ...
									 'mainmenu'=>'@pos',
									 'url'=>'/doliposbar/backend/listefac.php?viewstatut=2',
									 'langs'=>'bills',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									 'position'=>100,
									 'enabled'=>'$conf->global->POS_FACTURE',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									 'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r]=array(	'fk_menu'=>'r=9',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'mainmenu'=>'@pos',
									'url'=>'/doliposbar/backend/listefac.php?viewstatut=3',
									'langs'=>'bills',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>100,
									'enabled'=>'$conf->global->POS_FACTURE',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		$this->menu[$r]=array(	'fk_menu'=>'r=9',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									 ...
									 'mainmenu'=>'@pos',
									 'url'=>'/doliposbar/backend/listefac.php?viewtype=2',
									 'langs'=>'main',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									 'position'=>100,
									 'enabled'=>'$conf->global->POS_FACTURE',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									 'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		// Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=15',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'mainmenu'=>'@pos',
									'url'=>'/doliposbar/backend/closes.php',
									'langs'=>'main',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>101,
									'enabled'=>'1',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		// Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=17',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'titre'=>'Arqueo',
									'mainmenu'=>'@pos',
									'url'=>'/doliposbar/backend/closes.php?viewstatut=0',
									'langs'=>'main',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>101,
									'enabled'=>'1',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		// Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=17',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'titre'=>'Closes',
									'mainmenu'=>'@pos',
									'url'=>'/doliposbar/backend/closes.php?viewstatut=1',
									'langs'=>'main',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>102,
									'enabled'=>'1',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
									'perms'=>'$user->rights->pos->backend',			// Use 'perms'=>'$user->rights->mymodule->level1->level2' if you want your menu with a permission rules
		...
		// Example to declare another Left Menu entry:
		 $this->menu[$r]=array(	'fk_menu'=>'r=0',		// Use r=value where r is index key used for the parent menu entry (higher parent must be a top menu entry)
									...
									'titre'=>'Transfer',
									'mainmenu'=>'@pos',
									'url'=>'/doliposbar/backend/transfers.php',
									'langs'=>'main',	// Lang file to use (without .lang) by module. File must be in langs/code_CODE/ directory.
									'position'=>102,
									'enabled'=>'1',			// Define condition to show or hide menu entry. Use '$conf->mymodule->enabled' if entry must be visible if module is enabled.
	...
	function init()
	{
		...
		dol_mkdir($dirodt);
		dol_copy(dol_buildpath('/doliposbar/frontend/img/noimage.jpg',0),$dirodt.'/noimage.jpg',0,0);
		
		if(empty($conf->global->POS_USE_TICKETS))
		{
			
			dolibarr_set_const($db,"POS_USE_TICKETS", '1','chaine',0,'',$conf->entity);
			dolibarr_set_const($db,"POS_MAX_TTC", '3000','chaine',0,'',$conf->entity);
		}
	...
	{
		return $this->_load_tables('/doliposbar/sql/');
	}
}
