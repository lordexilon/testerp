...
if (pos_check_config() < 0)
{
	print '<div class="error">';
	print $langs->trans("NoPOSMulticompany");
	print '</div>';
}
else
{
...
else
{
	...
	$sql.= " WHERE fk_statut in (1,2,3,4)";
	...
	$sql.= " WHERE fac.fk_statut in (1,2,3,4)";
	...
	if ($mode == 'standard')
	{
		...
		$sql.= " FROM ".MAIN_DB_PREFIX."pos_ticket";
		$sql.= " WHERE date_creation >= '".$year."-".$month."-01 00:00:00'";
		...
		$sql.= " FROM ".MAIN_DB_PREFIX."pos_facture as pf, ".MAIN_DB_PREFIX."facture as fac";
		$sql.= " WHERE fac.datec >= '".$year."-".$month."-01 00:00:00'";
	...
	if ($mode == 'standard')
	{
		...
		$sql.= ", SUM(total_ttc)";
		$sql.= " FROM ".MAIN_DB_PREFIX."pos_ticket";
		$sql.= " WHERE date_creation >= '".$year."-01-01 00:00:00'";
		...
		$sql.= " FROM ".MAIN_DB_PREFIX."pos_facture as pf, ".MAIN_DB_PREFIX."facture as fac";
		$sql.= " WHERE fac.datec >= '".$year."-01-01 00:00:00'";
