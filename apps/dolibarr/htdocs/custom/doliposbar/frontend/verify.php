...
//require_once(DOL_DOCUMENT_ROOT.'/doliposbar/include/environnement.php');
...
if (empty($username))
{
	...
	header ('Location: index.php?err='.urlencode($retour).'&user='.$username.'&terminal='.$terminalid);
	exit;
}

// Check third party id
/* Not implemented in DoliposBAR
if (! ($terminalid > 0))
{
...
/*		
		include_once('../backend/class/cash.class.php');
