...
/**
 *  \file       htdocs/doliposbar/class/place.class.php
 *  \ingroup    ticket
...
class Place extends CommonObject
{
    ...
    function getNomUrl($withpicto=0)
    {
		...
		$lien = '<a href='.dol_buildpath('/doliposbar/backend/place/fiche.php',1).'?id='.$this->id.'>';
		$lienfin='</a>';
    ...
    function getTicketUrl($withpicto=0)
    {
    	...
    	{
    		$obj=$this->db->fetch_object($resql);
    		$lien = '<a href='.dol_buildpath('/doliposbar/backend/ticket.php',1).'?id='.$this->fk_ticket.'>';
    		$lienfin='</a>';
