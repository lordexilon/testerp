...
/**
 *  \file       htdocs/doliposbar/class/cash.class.php
 *  \ingroup    ticket
...
class Cash extends CommonObject
{
    ...
    function getNomUrl($withpicto=0)
    {
		...
		$lien = '<a href='.dol_buildpath('/doliposbar/backend/terminal/fiche.php',1).'?id='.$this->id.'>';
		$lienfin='</a>';
...
class ControlCash extends CommonObject
{
    ...
    function get_datafromlastclosing()
    {
    	...
    	$sql .=" where type_control = 1 and fk_cash=".$conf->global->POS_DEFAULT_CASH;
	...
	function getMoneyCash($open=false)
	{
        ...
        $acount=$conf->global->POS_DEFAULT_CASH;
